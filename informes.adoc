...
serão postados na https://www.ime.usp.br/~ivanstru/Site/MAT-112-2020_files/COVID-19/[homepage do professor].
...
O professor Ivan Chestakov ainda não se pronunciou publicamente sobre essa questão. Porém, a um e-mail de um aluno
o indagando sobre esta questão, respondeu que não ministraria as aulas de forma online.
...
Há três listas já disponibilizadas na https://www.ime.usp.br/~dpdias/2020/MAT2351.html[página do professor.]
...
A professora Claudia Cueva Candido está mantendo o contato, para retirar dúvidas 
e compartilhar informações, com as(os) estudantes por meio do Google-Meet e https://zoom.us[Zoom.]
...
Aguardando resposta do professor Marcos Magalhães quanto ao canal a ser adotado para 
comunicação com as(os) estudantes durante o período de quarentena.
...
O professor Routo Terada prosseguirá o calendário letivo com aulas onlines através do
Google-Meet. O link é disponibilizado um pouco antes do horário de aula no [https://paca.ime.usp.br/login/index.php]PACA.

Para dúvidas e demais informações, há um grupo da disciplina no Telegram: t.me/cripto2020ime
...
O professor Marcelo Finger prosseguirá com atividades online, adotando o uso do Google-Meet.
...
A professora Kelly Rosa Braghetto dará continuidade usando as seguintes plataformas:
